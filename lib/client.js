...
var net  = require('net'),
    ...
    debug = require('debug')('kafka-node-slim:Client');
/**
 ...
 * var client = new Client('localhost:2181,localhost:2182/example/chroot
 *
...
var Client = function (connectionString, clientId, zkOptions) {
    ...
    this.clientId = clientId || 'kafka-node-slim-client';
